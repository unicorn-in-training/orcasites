 ...
 *
 * Description: This is the template for the site's contact page. It is full width and does not contain a right sidebar.
 *
 * @package    WordPress
    ...
    ?>
            ...
            <section id="page-container" class="col-md-12">
                <section <?php post_class(); ?> id="post-<?php the_ID(); ?>">
                    ...
                    <section id="contact-content" class="col-md-12">
